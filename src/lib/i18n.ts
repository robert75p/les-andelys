  ...
  fr: {
    ...
    contact: {
      ...
      fields: {
        ...
        successMessage: 'Votre demande a bien été transmise. Nous reviendrons vers vous dans les meilleurs délais.',
  ...
  en: {
    ...
    contact: {
      ...
      fields: {
        ...
        submitting: 'Sending…',
        submitted: 'Enquiry sent successfully',
        successMessage: 'Your enquiry has been received. We will get back to you as soon as possible.',
        errorMessage: 'Something went wrong. Please try again or contact us directly by email.',
      },
      agent: {
        name: 'Michel G.',
        title: 'Owner',
  ...
  de: {
    ...
    contact: {
      ...
      fields: {
        ...
        submitted: 'Anfrage erfolgreich gesendet',
        successMessage: 'Ihre Anfrage ist eingegangen. Wir melden uns so schnell wie möglich bei Ihnen.',
        errorMessage: 'Ein Fehler ist aufgetreten. Bitte versuchen Sie es erneut oder kontaktieren Sie uns direkt per E-Mail.',
      },
      agent: {
        name: 'Michel G.',
        title: 'Eigentümer',
  ...
  it: {
    ...
    contact: {
      ...
      fields: {
        ...
        successMessage: 'La vostra richiesta è stata ricevuta. Vi risponderemo il prima possibile.',
        errorMessage: "Si è verificato un errore. Riprovate o contattateci direttamente via email.",
      },
      agent: {
        name: 'Michel G.',
        title: 'Proprietario',
  ...
  zh: {
    ...
    contact: {
      ...
      fields: {
        ...
        submitting: '发送中…',
        submitted: '咨询已成功发送',
        successMessage: '您的咨询已收到。我们将尽快与您联系。',
        errorMessage: '发生错误，请重试或直接通过电子邮件联系我们。',
      },
      agent: {
        name: 'Michel G.（房产所有者）',
        title: '所有者',
